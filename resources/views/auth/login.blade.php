...
<html class="no-js" lang="en">
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">
        <title>Afribary Scholarships</title>
        <meta name="description" content="Afribary Scholarships publishes thousands of verified scholarship and study abroad opportunities for Nigerians">
        ...
        <div class="container">
          ...
          <nav class="navbar navbar-expand-lg navbar-dark pt-4 px-0">
            <a class="navbar-brand" href="#">
              <img src="{{ secure_asset('images/landing/logo-white-small.png') }}" class="mr-2" alt="Afribary Scholarships">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              ...
              <ul class="navbar-nav ml-auto">
                ...
                @auth
                <li class="nav-item">
                  <a class="nav-link" href="{{ secure_url('home') }}"><i class="fas fa-user"></i> Dashboard</a>
                </li>
                 @else
    ...
    <div class="row justify-content-center mt-20">
      ...
      <footer>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <div class="container">
            <a class="navbar-brand" href="#">Afribary Scholarships</a>
